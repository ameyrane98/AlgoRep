import { AlgoRepError } from "./util.js";
...
function sortTopicsInReadme(markdownFile) {
  ...
  if (leetCodeSection == null) throw new AlgoRepError('LeetCodeTopicSectionNotFound');
  ...
  topics = topics.map(section => {
    ...
    if (topicHeaderIndex < leetCodeSectionStartIndex) {
      ...
      if (endTopicString == null) throw new AlgoRepError('EndOfTopicNotFound');
